    ...
    <div class="wrapper">
      ...
      <div class="body">
        ...
        <div class="container-fluid pending-vend comp-seller-myorders">
          <div class="row mt-4">
            <div class="col-sm-12">
              <div class="container-fluid container-sp-box">
                <div class="row">
                  <div class="col-md-4">
                    <div class="p-successful-orders">
                      <div class="icon-container">
                        <img
                          src="/src/assets/img/dashboard-icon-22.jpg"
                          alt=""
                        />
                      </div>
                      <div class="details">
                  ...
                  <div class="col-md-4">
                    <div class="p-successful-orders">
                      <div class="icon-container">
                        <img
                          src="/src/assets/img/dashboard-icon-23.jpg"
                          alt=""
                        />
                      </div>
                      <div class="details">
                ...
                <div class="foot-table" v-if="total > 0">
                  ...
                  <div class="right">
                    ...
                    <img
                      ...
                      @click="getOrders(current_page - 1)"
                      alt=""
                      class="prev-itm"
                    />
                    <img
